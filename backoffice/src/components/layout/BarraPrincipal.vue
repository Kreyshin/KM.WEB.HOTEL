...
<template>
  <!--
    Azul noche en los dos temas: es el ancla de la identidad y no debe
    depender de la preferencia de tema del usuario.
  -->
  <nav
    class="flex w-[var(--hs-rail-ancho)] shrink-0 flex-col items-center bg-rail py-5"
  ...
  >
    ...
    >
      <MarcaAlba :tamano="40" />
      <span class="hs-display text-[15px] leading-none font-semibold text-rail-tinta">
        {{ marca.nombre }}
      </span>
    </RouterLink>

    <div class="hs-filete mt-4 w-12 shrink-0" role="presentation" />
