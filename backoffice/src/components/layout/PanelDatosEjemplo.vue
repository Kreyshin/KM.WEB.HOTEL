    ...
    <div class="flex flex-col gap-8">
          ...
          <button
            ...
            :class="
              latencia === p.latenciaMs && tasaError === p.tasaError
                ...
                : 'border-linea text-tenue hover:border-azul hover:text-tinta'
            "
            @click="usarPerfil(p)"
          >
            {{ p.etiqueta }}
      ...
      <section class="flex flex-col gap-3 rounded-card border border-linea bg-panel-2 p-4">
        ...
        <div>
          <RouterLink
            ...
            class="text-sm font-medium text-azul underline"
      ...
      <section class="flex flex-col gap-3 rounded-card border border-linea bg-panel-2 p-4">
        <div>
          ...
          <p class="text-xs text-tenue">
            Borra los cambios hechos en este navegador y restaura sedes, pisos, habitaciones,
            reservas, inventario y usuarios de ejemplo.
          </p>
        </div>
        <div>
