...
<template>
  <div ref="contenedor" class="relative" @keydown.escape="abierto = false">
    ...
    >
      <span>
        <span class="hs-etiqueta block text-tenue">Sede</span>
        <span class="hs-display block text-sm font-semibold text-tinta">
    ...
    <ul
      ...
      class="hs-entrada absolute right-0 z-30 mt-2 w-64 overflow-hidden rounded-control border border-linea bg-panel py-1"
