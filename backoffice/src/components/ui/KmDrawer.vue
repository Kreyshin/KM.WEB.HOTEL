...
<template>
  <Teleport to="body">
    <Transition name="hs-drawer">
      <div v-if="abierto" class="fixed inset-0 z-50 flex justify-end">
        <div class="hs-drawer-velo absolute inset-0 bg-black/45" @click="abierto = false" />
...
.hs-drawer-enter-from .hs-drawer-panel,
.hs-drawer-leave-to .hs-drawer-panel {
